...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="fungsi/login.php" method="post">
            <h1 class="h3 mb-3 fw-normal text-center">Login Admin PPDB</h1>
            ...
            <p class="mt-5 mb-3 text-body-secondary text-center">&copy; 2024 | PPDB YAYASAN IR. H. MAULANA LANGKAT</p>
        </form>
    </main>
